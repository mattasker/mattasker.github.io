...
![Example of a metapopulation switching between two environments. The heatmaps show the region where mutants can be eradicated without risking total population extinction in yellow.](../assets/img/publication_preview/paper4.jpg)
