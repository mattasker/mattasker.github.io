...
<p align="center">
  <img src="/mattasker.github.io/assets/img/publication_preview/paper4.jpg" alt="Example of a metapopulation switching between two environments. The heatmaps show the region where mutants can be eradicated without risking total population extinction in yellow." style="max-width:100%; height:auto; display:block; margin:auto;">
</p>

Read the paper here: [10.1103/6w4h-8xvk](https://doi.org/10.1103/6w4h-8xvk).
